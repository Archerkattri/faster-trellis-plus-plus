...
<p>
  ...
  <a href="https://github.com/Archerkattri/faster-trellis-plus-plus/releases"><img alt="Downloads" src="https://img.shields.io/github/downloads/Archerkattri/faster-trellis-plus-plus/total?label=downloads&color=1f6feb"></a>
...
- **Sibling:** [`faster-trellis`](https://github.com/Archerkattri/faster-trellis) — the same base model with the HiCache (scaled-Hermite) polynomial-forecast variant.
