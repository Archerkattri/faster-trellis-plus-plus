...
class TrellisImageTo3DPipeline(Pipeline):
    ...
    def __init__(
        ...
        # Faster-TRELLIS acceleration mode ("none" | "hicache" | "faster").
        # Set via enable_faster_mode(...); "faster" is the full HiCache +
        # Adaptive-Guidance stack.
        self.faster_mode = "none"
    ...
    def _init_image_cond_model(self, name: str):
        ...
        if _local_hub and _os.path.isdir(_local_hub):
            dinov2_model = torch.hub.load(_local_hub, name, pretrained=True, source='local')
        else:
    ...
    # ------------------------------------------------------------------ #
    # Faster-TRELLIS acceleration                                        #
    # ------------------------------------------------------------------ #
    def enable_faster_mode(
        self,
        mode: str = "faster",
